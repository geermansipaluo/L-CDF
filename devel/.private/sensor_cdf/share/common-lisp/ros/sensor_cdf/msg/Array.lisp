...
(cl:defmethod cl:initialize-instance :after ((m <Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_cdf-msg:<Array> is deprecated: use sensor_cdf-msg:Array instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_cdf-msg:data-val is deprecated.  Use sensor_cdf-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'rows-val :lambda-list '(m))
(cl:defmethod rows-val ((m <Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_cdf-msg:rows-val is deprecated.  Use sensor_cdf-msg:rows instead.")
  (rows m))

(cl:ensure-generic-function 'cols-val :lambda-list '(m))
(cl:defmethod cols-val ((m <Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_cdf-msg:cols-val is deprecated.  Use sensor_cdf-msg:cols instead.")
  (cols m))
